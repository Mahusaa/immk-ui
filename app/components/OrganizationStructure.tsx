...
const divisiEksternal = [
  {
    ...
    kepalaImage: '/kadiv-pjk.png',
    wakil: ['Putri Afra, S.H.'],
    wakilImage: ['/wakadiv-pjk.png'],
  },
  {
    name: 'Divisi Pengabdian Masyarakat (Pengmas)',
    kepala: 'Gamast M. Fazzira, S.H.',
    kepalaImage: '/kadiv-pengmas.png',
    wakil: ['Niken Mulya, S.H.'],
    wakilImage: ['/wakadiv-pengmas.png'],
  },
];
...
export const OrganizationStructure = () => {
  return (
    <section id="organization" className="bg-[#F2F2F2] py-10 sm:py-16 lg:py-20 scroll-mt-24">
      ...
      <div className="w-full max-w-2xl mx-auto">
        <div className="bg-[#F2F2F2] rounded-xl p-4 sm:p-6 lg:p-8">
          <div className="grid grid-cols-1 gap-6 lg:gap-8 justify-items-center">
